		       ...
		       text: "相亲活动管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "ActivityInfo/activityInfo_userAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我发布的相亲活动",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ActivityInfo/activityInfo_userQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "用户报名查询",
			    	   ...
			    	   [
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SignUp/signUp_userQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "相亲咨询管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "UserInfo/userInfo_selfModify.jsp"
			    	   	}
			    	   ]
			}],
