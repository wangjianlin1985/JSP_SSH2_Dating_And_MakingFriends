...
<jsp:include page="check_zuzhizhe_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">婚恋交友网系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("zuzhizhe")%> | <a href="logout.jsp">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_zuzhizhe.js"></script>
</body>
</html>
